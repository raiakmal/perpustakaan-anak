...
export default async function FiksiPage() {
  const books = await fetchBooksByCategory('Fiksi'); // Menggunakan "books" agar konsisten dengan istilah data buku
    ...
    <div className="relative px-4 lg:px-0">
      <section className="py-12 bg-white">
        <div className="container mx-auto">
          ...
          {/* Judul Halaman */}
          <h2 className="mb-8 text-3xl font-bold text-center text-primary">Kategori Fiksi</h2>
