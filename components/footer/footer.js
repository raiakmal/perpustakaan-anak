      ...
      <div className="container">
        <div className="flex flex-wrap">
          ...
          <div className="w-full px-4 mb-8 md:w-1/3">
            <h3 className="font-semibold text-xl text-white">Events</h3>
            <ul className="text-stone-400">
              <li>
                <a href="#" className="inline-block text-base hover:text-primary">
                  Formal
                </a>
              </li>
              <li>
        ...
        <div className="w-full pt-10 border-t border-slate">
          <div className="flex items-center justify-center mb-5">
            {/* Whatsapp */}
            <a href="#" target="_blank" className="w-9 h-9 mr-3 rounded-full flex justify-center items-center text-white border border-secondary hover:border-primary hover:bg-primary hover:text-white">
