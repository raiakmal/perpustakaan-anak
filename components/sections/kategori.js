      ...
      <div className="container">
        <div className="w-full px-4">
          <div className="max-w-full mx-auto mb-16 text-center">
            ...
            <p className="max-w-xl mx-auto text-base text-slate lg:text-lg">Lorem ipsum dolor sit amet consectetur adipisicing elit. Repellat, reiciendis.</p>
          </div>
        </div>
        <div className="flex flex-wrap justify-center w-full px-4 lg:space-x-20">
          ...
          <a href="/user/kategori1">
            <div className="p-4 mb-12 transition duration-300 hover:scale-105">
              ...
              <h3 className="mt-6 mb-3 text-xl font-semibold text-center text-dark lg:text-2xl">Kategori 1</h3>
            </div>
          </a>
          ...
          <a href="/user/kategori2">
            <div className="p-4 mb-12 transition duration-300 hover:scale-105">
              ...
              <h3 className="mt-6 mb-3 text-xl font-semibold text-center text-dark lg:text-2xl">Kategori 2</h3>
            </div>
          </a>
          ...
          <a href="/user/kategori3">
            <div className="p-4 mb-12 transition duration-300 hover:scale-105">
              ...
              <h3 className="mt-6 mb-3 text-xl font-semibold text-center text-dark lg:text-2xl">Kategori 3</h3>
            </div>
          </a>
          ...
          <a href="/user/kategori4">
            <div className="p-4 mb-12 transition duration-300 hover:scale-105">
              ...
              <h3 className="mt-6 mb-3 text-xl font-semibold text-center text-dark lg:text-2xl">Kategori 4</h3>
            </div>
          </a>
        </div>
      </div>
